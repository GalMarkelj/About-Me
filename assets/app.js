(() => {
    ...
    "node_modules/lodash/lodash.js"(exports, module) {
      (function() {
        ...
        var runInContext = function runInContext2(context) {
          ...
          var nativeCeil = Math2.ceil, nativeFloor = Math2.floor, nativeGetSymbols = Object2.getOwnPropertySymbols, nativeIsBuffer = Buffer2 ? Buffer2.isBuffer : undefined2, nativeIsFinite = context.isFinite, nativeJoin = arrayProto.join, nativeKeys = overArg(Object2.keys, Object2), nativeMax2 = Math2.max, nativeMin2 = Math2.min, nativeNow = Date.now, nativeParseInt = context.parseInt, nativeRandom = Math2.random, nativeReverse = arrayProto.reverse;
  ...
  // src/js/helpers/toogle-navigation.js
  var toggleNavigation = (nav) => {
  ...
  // src/js/helpers/slider.js
  var slider = (btn, elements, slider2) => {
    let elList = [];
    let index;
    elements.forEach((el) => {
    ...
    function enableStyle(element) {
      ...
      slider2.style.paddingBottom = `${checkHeight(elHeight, elDropdownHeight)}px`;
  ...
  // src/js/helpers/dropdown-absolute.js
  var dropdownAbs = (element, dropdown, wrapper) => {
  ...
  // src/js/helpers/fade-slider.js
  var fadeSlider = (items, clickedItem, dots) => {
    const sliderWrapper = document.querySelector(".fadeSlider");
    const itemsList = [];
    let index;
    items.forEach((item) => {
      if (!item.getAttribute("data-sliderItem"))
        return;
    ...
    itemTrack(dots);
    function itemTrack(dots2) {
      if (clickedItem.classList.contains("fadeSlider--active"))
        return;
      dots2.forEach((dot) => {
  ...
  // src/js/helpers/dropdown-block.js
  var dropdownBlock = (element, dropdown) => {
    if (!element.classList.contains("active--dropdown")) {
    ...
    function enableDropdown(element2, dropdown2) {
      element2.classList.add("active--dropdown");
      enableStyle(element2, dropdown2);
    }
    function disableDropdown(element2) {
      element2.classList.remove("active--dropdown");
      disableStyle(element2);
    }
    function enableStyle(element2, dropdown2) {
      let contentHeight = dropdown2.getBoundingClientRect().height;
      element2.style.paddingBottom = `${contentHeight}px`;
    }
    function disableStyle(element2) {
      element2.style.paddingBottom = `unset`;
    }
  };

  // src/js/helpers/handleClicks.js
  var handleClicks = (e) => {
  ...
  // src/js/helpers/execute-on-load.js
  var import_lodash = __toESM(require_lodash());
  var executeOnLoad = () => {
    function fadeSlider2() {
    ...
    function slider2() {
      ...
      function enableStyle(item, slider3) {
        const itemHeight = item.offsetHeight;
        const itemDropdownHeight = item.querySelector(".project__description-wrapper").offsetHeight;
        slider3.style.paddingBottom = `${checkHeight(itemHeight, itemDropdownHeight)}px`;
        function checkHeight(item2, dropdown) {
          if (window.innerWidth > 786) {
            return item2 + dropdown;
          } else {
            return item2;
          }
        }
  ...
  var events = () => {
    ...
    window.addEventListener("resize", throttle_default(executeOnLoad, 200));
  };
